...
def create_report():
    ...
    report.output(Output_Address+"/" + current_time +" Sonography Report.pdf" )
    Successful_Generation_prompt = tk.Label(root, text="Report successfully saved to " + Output_Address + " at\n" + current_time, font=("Arial", 8), background="#D3D3D3", fg="red")
...
root.title("Paedeatric Sonography Example report")
